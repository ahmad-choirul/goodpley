    ...
    <div class="row">
      <div class="col-md-5">
        <div class="form-group">
            ...
            <input type="hidden" name="id" value="<?php echo $sewa_advertise->id ?>" class="form-control" placeholder="nama pemilik">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <strong>id_sewa_advertise</strong>
            <input type="text" name="id_advertise" value="<?php echo $sewa_advertise->id_advertise ?>" class="form-control" placeholder="id_sewa_advertise lokasi">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <strong>tgl_mulai_sewa</strong>
            <input type="date" name="tgl_mulai_sewa" value="<?php echo $sewa_advertise->tgl_mulai_sewa ?>" class="form-control" placeholder="tgl_mulai_sewa lokasi">
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
          ...
          <select class="form-control m-bot15" name="status">
                        ...
                        <option value="0" <?php echo ( $sewa_advertise->status == '0') ? 'selected' : '' ?> >Belum</option>
                        <option value="1" <?php echo ( $sewa_advertise->status == '1') ? 'selected' : '' ?> >Sudah</option>
                    </select>
          </div>
      </div>
